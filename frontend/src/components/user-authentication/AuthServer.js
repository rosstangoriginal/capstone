...
const jwtSecretKey = "oppenheimer"
...
app.post("/auth", (req, res) => {
    ...
    const user = ["Darth.Vader@gmail.com"]

    // If found, compare the hashed passwords and generate the JWT token for the user
    if (user.length === 1) {
        // bcrypt.compare(password, user[0].password, function (_err, result) {
        bcrypt.compare(password, "$2y$10$vOavYUocZ51vrhxWTnbO7.deYi509CRr/JA0U0oRRKfve127W08Bq", function (_err, result) {    
            if (!result) {
